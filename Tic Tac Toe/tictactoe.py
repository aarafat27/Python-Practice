...
def btnClick(buttons):
    ...
    if buttons['text'] == " " and bclick == True:
        ...
        tkinter.messagebox.showinfo('TicTakToe', 'Button already clicked')
...
def checkforwin():
    if (button1['text'] == "X" and button2['text'] == "X" and button3['text'] == "X" or
        ...
        disableButton()
        tkinter.messagebox.showinfo('Tick Tac Toe', playerA)

    elif flag == 8:
        tkinter.messagebox.showinfo('Tick Tac Toe', 'It is a Tie')
        ...
        disableButton()
        tkinter.messagebox.showinfo('Tick Tac Toe', playerB)
